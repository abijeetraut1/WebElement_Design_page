...
export default function AiIntro() {
    return (
        <section className='bg-black p-2 w-full flex flex-col justify-center'>
            <section className='mx-4 space-y-5'>
                <div className="text-left sm:mx-20">
                    <div>
                        <heading className="capitalize text-mobileHeadingTextSize flex flex-col font-light tracking-tight text-white sm:text-5xl">
                            {/* Design Once, Code Never: <br /> Empowering Designers with <br /> CodeBro */}
                            Design Once, Code Never <br />  Empowering Designers with AI
                        </heading>
                    </div>
                </div>
                <div>
